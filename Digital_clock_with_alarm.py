...
root.minsize(873,591)
 
# set maximum window size value
root.maxsize(873,591)
...
def calender():
    ...
    calen.geometry("250x200")
    # set minimum window size value
    calen.minsize(250,200)
    
    # set maximum window size value
    calen.maxsize(250,200)
    #for transparent window
...
def stopwatch():
    ...
    start_button = Button(sw,text='start', height=5, width=4,bg = "black", fg = "white", font=('ds-digital', 20), command=start)
...
Stopwatch = Button(root, text = 'Stopwatch', font=("ds-digital 15 bold"),height=5, width=11,fg="red",bg="yellow",padx = 50, command = stopwatch)
Stopwatch.pack(side = LEFT)
#for alarm button
setAlarm = Button(root, text = 'Alarm', font=("ds-digital 15 bold"),height=5, width=11,fg="red",bg="yellow",padx = 50, command = alarm)
setAlarm.pack(side = LEFT)
#for stop alarm button
stopAlarm = Button(root, text = 'Stop',font=("ds-digital 15 bold"),height=5, width=11,fg="red",bg="yellow", state = DISABLED, padx = 50, command = stopAlarm)
stopAlarm.pack(side = LEFT)
#for calender button
Calender = Button(root, text = 'Calender',font=("ds-digital 15 bold"),height=5, width=11,fg="red",bg="yellow", padx = 50, command = calender).pack(side=LEFT)
